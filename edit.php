<?php
    ...
    if($_GET["item_id"]){
        ...
        //Select specific columns from the two tables
        ...
        //Fetch the columns we want to put on the input fields, text area, etc.
